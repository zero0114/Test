...
<div class="row">
  <div class="col-lg-12">
    <div class="card">
      <div class="card-header text-white" style="background-color: #8b7ca8;">${article.boardNo}번 게시물 수정</div>
      <div class="card-body">
        ...
        <form role="form" method="post">
          ...
          <div class="form-group">
            <label>제품명</label>
            <input type="text" class="form-control" name='pName' value="${article.pName}">
          </div>
          <div class="form-group">
            <label>제조사</label>
            <input type="text" class="form-control" name='pMake' value="${article.pMake}">
          </div>
		...
		style="background-color: #8b7ca8; margin-top: 0; height: 40px; color: white; border: 0px solid #388E3C; opacity: 0.8">목록</a>&nbsp;&nbsp;
